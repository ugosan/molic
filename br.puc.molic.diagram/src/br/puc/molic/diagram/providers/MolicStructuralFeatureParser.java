 ...
 * @generated
 */
public class MolicStructuralFeatureParser extends MolicAbstractParser {
	 ...
	 * @generated
	 */
	public MolicStructuralFeatureParser(EStructuralFeature feature) {
	...
	protected IParserEditStatus validateValues(Object[] values) {
		...
		if (value instanceof InvalidValue) {
			return new ParserEditStatus(MolicDiagramEditorPlugin.ID,
