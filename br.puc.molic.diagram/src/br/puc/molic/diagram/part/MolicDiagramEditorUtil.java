 ...
 * @generated
 */
public class MolicDiagramEditorUtil {
	...
	public static Resource openModel(Shell shell, String description,
		...
		try {
			...
			MessageDialog
					.openError(
							shell,
							Messages.MolicDiagramEditorUtil_OpenModelResourceErrorDialogTitle,
							NLS
									.bind(
											Messages.MolicDiagramEditorUtil_OpenModelResourceErrorDialogMessage,
											fileName));
		}
		return resource;
	}
	...
	public static void runWizard(Shell shell, Wizard wizard, String settingsKey) {
		IDialogSettings pluginDialogSettings = MolicDiagramEditorPlugin
	...
	public static Resource createDiagram(URI diagramURI,
		...
		progressMonitor.beginTask(
				Messages.MolicDiagramEditorUtil_CreateDiagramProgressTask, 3);
		final Resource diagramResource = editingDomain.getResourceSet()
				.createResource(diagramURI);
		final String diagramName = diagramURI.lastSegment();
		AbstractTransactionalCommand command = new AbstractTransactionalCommand(
				editingDomain,
				Messages.MolicDiagramEditorUtil_CreateDiagramCommandLabel,
				Collections.EMPTY_LIST) {
			protected CommandResult doExecuteWithResult(
					IProgressMonitor monitor, IAdaptable info)
					throws ExecutionException {
				br.puc.molic.Diagram model = createInitialModel();
				attachModelToResource(model, diagramResource);

				Diagram diagram = ViewService.createDiagram(model,
						DiagramEditPart.MODEL_ID,
						MolicDiagramEditorPlugin.DIAGRAM_PREFERENCES_HINT);
				if (diagram != null) {
				...
				try {
					...
					diagramResource
							.save(br.puc.molic.diagram.part.MolicDiagramEditorUtil
									.getSaveOptions());
				} catch (IOException e) {
	 ...
	 * @generated
	 */
	private static br.puc.molic.Diagram createInitialModel() {
		return MolicFactory.eINSTANCE.createDiagram();
	}
	 ...
	 * @generated
	 */
	private static void attachModelToResource(br.puc.molic.Diagram model,
			Resource resource) {
