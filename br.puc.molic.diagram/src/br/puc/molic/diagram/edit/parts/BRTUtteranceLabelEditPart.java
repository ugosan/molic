 ...
 * @generated
 */
public class BRTUtteranceLabelEditPart extends LabelEditPart implements
		ITextAwareEditPart {
	...
	static {
		registerSnapBackPosition(
				MolicVisualIDRegistry
						.getType(br.puc.molic.diagram.edit.parts.BRTUtteranceLabelEditPart.VISUAL_ID),
				new Point(0, 40));
	}
	 ...
	 * @generated
	 */
	public BRTUtteranceLabelEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			...
			IAdaptable hintAdapter = new MolicParserProvider.HintAdapter(
					MolicElementTypes.BRTUtterance_4002, getParserElement(),
					parserHint);
