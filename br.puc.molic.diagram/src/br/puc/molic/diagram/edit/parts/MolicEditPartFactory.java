 ...
 * @generated
 */
public class MolicEditPartFactory implements EditPartFactory {
	...
	public EditPart createEditPart(EditPart context, Object model) {
		if (model instanceof View) {
			...
			case SystemProcessEditPart.VISUAL_ID:
				return new SystemProcessEditPart(view);

			case MonologueEditPart.VISUAL_ID:
				return new MonologueEditPart(view);

			case MonologueLabelEditPart.VISUAL_ID:
				return new MonologueLabelEditPart(view);
			...
			case UtteranceLabelEditPart.VISUAL_ID:
				return new UtteranceLabelEditPart(view);

			case BRTUtteranceEditPart.VISUAL_ID:
				return new BRTUtteranceEditPart(view);

			case BRTUtteranceLabelEditPart.VISUAL_ID:
				return new BRTUtteranceLabelEditPart(view);
			}
		}
