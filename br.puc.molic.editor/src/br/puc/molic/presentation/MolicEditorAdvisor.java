...
import br.puc.molic.presentation.MolicEditorPlugin;
 ...
 * @generated
 */
public final class MolicEditorAdvisor extends WorkbenchAdvisor {
	/**
	...
	private static String getString(String key) {
		return MolicEditorPlugin.INSTANCE.getString(key);
	}
	...
	private static String getString(String key, Object s1) {
		return br.puc.molic.presentation.MolicEditorPlugin.INSTANCE.getString(key, new Object [] { s1 });
	}
	...
	public static class Application implements IApplication {
		...
		public Object start(IApplicationContext context) throws Exception {
			WorkbenchAdvisor workbenchAdvisor = new MolicEditorAdvisor();
	...
	public static class Perspective implements IPerspectiveFactory {
		 ...
		 * @generated
		 */
		public static final String ID_PERSPECTIVE = "br.puc.molic.presentation.MolicEditorAdvisorPerspective";
	...
	/**
	 * Open action for the objects from the Molic model.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	/**
	 * Open URI action for the objects from the Molic model.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
