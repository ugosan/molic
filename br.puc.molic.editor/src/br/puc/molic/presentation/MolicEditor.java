...
/**
 * This is an example of a Molic model editor.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class MolicEditor
			...
			public void partActivated(IWorkbenchPart p) {
				if (p instanceof ContentOutline) {
					if (((ContentOutline)p).getCurrentPage() == contentOutlinePage) {
						getActionBarContributor().setActiveEditor(MolicEditor.this);
	...
	protected void initializeEditingDomain() {
		...
		adapterFactory.addAdapterFactory(new MolicItemProviderAdapterFactory());
	...
	private static String getString(String key, Object s1) {
		return MolicEditorPlugin.INSTANCE.getString(key, new Object [] { s1 });
	}
