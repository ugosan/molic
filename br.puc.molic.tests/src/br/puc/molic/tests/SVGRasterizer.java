...
public class SVGRasterizer {
    ...
    public static void main(String [] args) throws Exception {
        SVGRasterizer r = new SVGRasterizer(new File("/home/ugo/molictest.svg").toURL());
        r.setBackgroundColor(java.awt.Color.white);
        BufferedImage img = r.createBufferedImage();
        javax.swing.JFrame f = new javax.swing.JFrame();
        f.getContentPane().add(new javax.swing.JLabel(new javax.swing.ImageIcon(img)), java.awt.BorderLayout.CENTER);  f.pack();
        f.show();
    }
}
